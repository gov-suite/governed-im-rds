...
class TestModelStructure extends gimTyp.TypicalInfoModelStructure {
...
class TestModelContent extends gimTyp.TypicalInfoModelContent {
  constructor(struct: TestModelStructure) {
    super(struct);
...
export class TestModel extends gimTyp.TypicalInformationModel {
  readonly structParams: gimTyp.TypicalInfoModelStructParams;
  readonly structure: TestModelStructure;

  constructor() {
    super();

    this.structParams = new models.DefaultInfoModelStructParams(
      ns.namespaceFactory.namespace("test"),
    );
    this.structure = new TestModelStructure(this.structParams);
    this.addContent(
      new TestModelContent(this.structure),
    );
  }
}
